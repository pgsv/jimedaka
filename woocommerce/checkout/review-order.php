...
?>
<table class="reviewOrder shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e('Product', 'woocommerce'); ?>
			</th>
			<th class="product-total"><?php esc_html_e('Subtotal', 'woocommerce'); ?>
			</th>
		</tr>
	</thead>
	<tbody>
	...
	<tfoot>
		...
		<tr
			class="tax-rate tax-rate-<?php echo esc_attr(sanitize_title($code)); ?>">
